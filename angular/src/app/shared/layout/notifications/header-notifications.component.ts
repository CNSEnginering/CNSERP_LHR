...
export class HeaderNotificationsComponent extends AppComponentBase implements OnInit {
    ...
    loadNotifications(): void {
        ...
        this._notificationService.getLogsDetails().subscribe(result => {
            this.logsNotifications  = result["result"];
            console.log("logs Notifications");
            console.log(this.logsNotifications);
        });
    }
