...
@Component({
    selector: "tooltypeLookupTableModal",
    styleUrls: ["./ToolType-table-modal.component.less"],
    encapsulation: ViewEncapsulation.None,
    templateUrl: "./ToolType-table-modal.component.html"
})
export class ToolTypeLookupTableModalComponent extends AppComponentBase {
