...
import { PagedResultDtoOfGetemployeeLoansForViewDto, CreateOrEditemployeeLoansDto, GetemployeeLoansForEditOutput } from "../dto/employeeLoans-dto";
...
export class EmployeeLoansService {
 ...
 /**
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetemployeeLoansForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetemployeeLoansForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetemployeeLoansForViewDto> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfGetemployeeLoansForViewDto.fromJS(resultData200) : new PagedResultDtoOfGetDepartmentForViewDto();
        ...
        return _observableOf<PagedResultDtoOfGetemployeeLoansForViewDto>(<any>null);
    }
    
    appUnAppLoan(id:any,stat:number){
        let url;
        url = this.baseUrl;
        url += "/api/services/app/EmployeeLoans/statusloan?Id=" + id+"&&stat="+stat;
    ...
    ProcessLoan(id:any){
        let url;
        url = this.baseUrl;
        url += "/api/services/app/EmployeeLoans/ProcessAdvance?Id=" + id;
        return this.http.get(url).pipe(map((response: any) => {
     ...
     * @return Success
     */
    createOrEdit(input: CreateOrEditemployeeLoansDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeLoans/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeLoans/Delete?";
        if (id !== undefined)
    ...
    getEmployeeLoansForEdit(id: number | null | undefined): Observable<GetemployeeLoansForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeLoans/GetEmployeeLoansForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processEmployeeLoansForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEmployeeLoansForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetemployeeLoansForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetemployeeLoansForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processEmployeeLoansForEdit(response: HttpResponseBase): Observable<GetemployeeLoansForEditOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = resultData200 ? GetemployeeLoansForEditOutput.fromJS(resultData200) : new GetemployeeLoansForEditOutput();
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetemployeeLoansForEditOutput>(<any>null);
    }
}