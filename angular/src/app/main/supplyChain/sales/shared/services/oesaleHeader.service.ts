...
import { PagedResultDtoOfOESALEHeaderDto, OESALEHeaderDto } from '../dtos/oesaleHeader-dto';

@Injectable({
    providedIn: 'root'
  })
export class OESALEHeadersService {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfOESALEHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfOESALEHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfOESALEHeaderDto> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfOESALEHeaderDto.fromJS(resultData200) : new PagedResultDtoOfOESALEHeaderDto();
        ...
        return _observableOf<PagedResultDtoOfOESALEHeaderDto>(<any>null);
    }
     ...
     * @return Success
     */
    getOESALEHeaderForEdit(id: number | null | undefined): Observable<OESALEHeaderDto> {
        let url_ = this.baseUrl + "/api/services/app/OESALEHeaders/GetOESALEHeaderForEdit?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOESALEHeaderForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOESALEHeaderForEdit(<any>response_);
                } catch (e) {
                    return <Observable<OESALEHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<OESALEHeaderDto>><any>_observableThrow(response_);
        }));
    }

    public processGetOESALEHeaderForEdit(response: HttpResponseBase): Observable<OESALEHeaderDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? OESALEHeaderDto.fromJS(resultData200) : new OESALEHeaderDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<OESALEHeaderDto>(<any>null);
    }
}