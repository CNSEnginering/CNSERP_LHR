...
import { PagedResultDtoOfOERETHeaderDto, OERETHeaderDto } from '../dtos/oeretHeader-dto';

@Injectable({
    providedIn: 'root'
  })
export class OERETHeadersService {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfOERETHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfOERETHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfOERETHeaderDto> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfOERETHeaderDto.fromJS(resultData200) : new PagedResultDtoOfOERETHeaderDto();
        ...
        return _observableOf<PagedResultDtoOfOERETHeaderDto>(<any>null);
    }
     ...
     * @return Success
     */
    getOERETHeaderForEdit(id: number | null | undefined): Observable<OERETHeaderDto> {
        let url_ = this.baseUrl + "/api/services/app/OERETHeaders/GetOERETHeaderForEdit?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOERETHeaderForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOERETHeaderForEdit(<any>response_);
                } catch (e) {
                    return <Observable<OERETHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<OERETHeaderDto>><any>_observableThrow(response_);
        }));
    }

    public processGetOERETHeaderForEdit(response: HttpResponseBase): Observable<OERETHeaderDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? OERETHeaderDto.fromJS(resultData200) : new OERETHeaderDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<OERETHeaderDto>(<any>null);
    }
}