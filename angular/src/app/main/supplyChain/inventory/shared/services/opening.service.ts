...
export class OpeningServiceProxy {
     ...
     * @return Success
     */
    createOrEditOpening(input: OpeningDto | null | undefined): Observable<void> {
        debugger;
        let url_ = this.baseUrl + "/api/services/app/Opening/CreateOrEditOpening";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditOpening(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditOpening(<any>response_);
                } catch (e) {
    ...
    protected processCreateOrEditOpening(response: HttpResponseBase): Observable<void> {
    ...
    getMaxDocId(): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Opening/GetMaxDocId";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Opening/Delete?";
        if (id !== undefined)
