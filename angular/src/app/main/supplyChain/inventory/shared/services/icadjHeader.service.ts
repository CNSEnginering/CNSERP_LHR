...
import { PagedResultDtoOfICADJHeaderDto, ICADJHeaderDto } from '../dto/icadjHeader-dto';
...
export class ICADJHeadersService {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfICADJHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfICADJHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfICADJHeaderDto> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfICADJHeaderDto.fromJS(resultData200) : new PagedResultDtoOfICADJHeaderDto();
        ...
        return _observableOf<PagedResultDtoOfICADJHeaderDto>(<any>null);
    }
     ...
     * @return Success
     */
    getICADJHeaderForEdit(id: number | null | undefined): Observable<ICADJHeaderDto> {
        let url_ = this.baseUrl + "/api/services/app/ICADJHeader/GetICADJHeaderForEdit?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetICADJHeaderForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetICADJHeaderForEdit(<any>response_);
                } catch (e) {
                    return <Observable<ICADJHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ICADJHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetICADJHeaderForEdit(response: HttpResponseBase): Observable<ICADJHeaderDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ICADJHeaderDto.fromJS(resultData200) : new ICADJHeaderDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ICADJHeaderDto>(<any>null);
    }
