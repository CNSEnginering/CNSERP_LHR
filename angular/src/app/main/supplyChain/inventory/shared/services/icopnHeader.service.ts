...
import { PagedResultDtoOfICOPNHeaderDto, ICOPNHeaderDto } from '../dto/icopnHeader-dto';
...
export class ICOPNHeadersService {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfICOPNHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfICOPNHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfICOPNHeaderDto> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfICOPNHeaderDto.fromJS(resultData200) : new PagedResultDtoOfICOPNHeaderDto();
        ...
        return _observableOf<PagedResultDtoOfICOPNHeaderDto>(<any>null);
    }
     ...
     * @return Success
     */
    getICOPNHeaderForEdit(id: number | null | undefined): Observable<ICOPNHeaderDto> {
        let url_ = this.baseUrl + "/api/services/app/ICOPNHeaders/GetICOPNHeaderForEdit?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ICOPNHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ICOPNHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetICOPNHeaderForEdit(response: HttpResponseBase): Observable<ICOPNHeaderDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ICOPNHeaderDto.fromJS(resultData200) : new ICOPNHeaderDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ICOPNHeaderDto>(<any>null);
    }
