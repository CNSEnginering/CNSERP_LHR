...
import { PagedResultDtoOfICWOHeaderDto, ICWOHeaderDto } from '../dto/icwoHeader-dto';

@Injectable({
    providedIn: 'root'
  })
export class ICWOHeadersService {
     ...
     * @return Success
     */
    getAll(filter: string | null | undefined,maxDocNoFilter: number | null | undefined,minDocNoFilter: number | null | undefined, maxDocDateFilter: moment.Moment, minDocDateFilter: moment.Moment, maxLocIDFilter: number | null | undefined, minLocIDFilter: number | null | undefined,approvedFilter: number | null | undefined,activeFilter: number | null | undefined,postedFilter: number | null | undefined, createdByFilter: string | null | undefined, maxCreateDateFilter: moment.Moment | null | undefined, minCreateDateFilter: moment.Moment | null | undefined,audtUserFilter: string | null | undefined,maxAudtDateFilter: moment.Moment | null | undefined, minAudtDateFilter: moment.Moment | null | undefined,  sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfICWOHeaderDto> {
        debugger;
        let url_ = this.baseUrl + "/api/services/app/ICWOHeaders/GetAll?";
        if (filter !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfICWOHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfICWOHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfICWOHeaderDto> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfICWOHeaderDto.fromJS(resultData200) : new PagedResultDtoOfICWOHeaderDto();
        ...
        return _observableOf<PagedResultDtoOfICWOHeaderDto>(<any>null);
    }
     ...
     * @return Success
     */
    getICWOHeaderForEdit(id: number | null | undefined): Observable<ICWOHeaderDto> {
        debugger;
        let url_ = this.baseUrl + "/api/services/app/ICWOHeaders/GetICWOHeaderForEdit?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetICWOHeaderForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetICWOHeaderForEdit(<any>response_);
                } catch (e) {
                    return <Observable<ICWOHeaderDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ICWOHeaderDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetICWOHeaderForEdit(response: HttpResponseBase): Observable<ICWOHeaderDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ICWOHeaderDto.fromJS(resultData200) : new ICWOHeaderDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ICWOHeaderDto>(<any>null);
    }
}