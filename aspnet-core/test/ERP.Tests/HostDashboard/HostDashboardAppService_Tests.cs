...
using ERP.MultiTenancy.HostDashboard;
...
namespace ERP.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ERPDbContext context, SubscriptionPayment subscriptionPayment)
        {
