...
{
    public partial class AllowanceDisbursment
    {
        bool _imageLogic;
        int _tenantId;
        public AllowanceDisbursment()
        {
            InitializeComponent();
            _imageLogic = false;
        }
        ...
        private void SalarySheetSummary_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
