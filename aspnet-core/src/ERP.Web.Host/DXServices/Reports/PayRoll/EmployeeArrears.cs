...
{
    public partial class EmployeeArrears
    {
        private int _tenantId;
        private bool _imageLogic;
        public EmployeeArrears()
        {
            InitializeComponent();
            _imageLogic = false;
        }

        private void EmployeeArrears_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
