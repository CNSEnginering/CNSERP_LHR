...
{
    public partial class SalarySheetSummaryNew
    {
        private int _tenantId;
        private bool _imageLogic;
        public SalarySheetSummaryNew()
        {
            InitializeComponent();
            _imageLogic = false;
        }
        ...
        private void SalarySheet_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
