...
{
    public partial class SalesTaxWithheld
    {
        private int _tenantId;
        public string DecimalPoints = "";

        public SalesTaxWithheld()
        {
            InitializeComponent();
        }
        private void SalesTaxWithheld_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
