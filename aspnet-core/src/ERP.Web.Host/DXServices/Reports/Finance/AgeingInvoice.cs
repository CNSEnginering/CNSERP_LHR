...
{
    public partial class AgeingInvoice
    {
        public AgeingInvoice()
        {
            InitializeComponent();
        }
        ...
        private void pictureBox1_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
                ...
                pictureBox1.ImageSource = new ImageSource(img);
        ...
        private void CustAnalysisReport_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            DevExpress.XtraReports.Parameters.Parameter param = ((XtraReport)sender).Parameters["TenantId"];
