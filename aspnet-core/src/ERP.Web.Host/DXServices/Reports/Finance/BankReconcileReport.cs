...
{
    public partial class BankReconcileReport
    {
        private int _tenantId;
        public string DecimalPoints = "";
        public BankReconcileReport()
        {
            InitializeComponent();
        }
        private void BankReconcileReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
