...
{
    public partial class CPRNumbersReport
    {
        private int _tenantId;
        public string DecimalPoints = "";
        public CPRNumbersReport()
        {
            InitializeComponent();
        }
        private void CPRNumbersReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.tableCell18.TextFormatString = "{0:N" + DecimalPoints + "}";
        }
