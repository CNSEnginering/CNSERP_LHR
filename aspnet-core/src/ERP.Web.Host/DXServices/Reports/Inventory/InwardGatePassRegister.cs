...
{
    public partial class InwardGatePassRegister
    {
        private int _tenantId;
        public string DecimalPoints = "";
        public InwardGatePassRegister()
        {
            InitializeComponent();
        }
        ...
        private void InwardRegister_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
