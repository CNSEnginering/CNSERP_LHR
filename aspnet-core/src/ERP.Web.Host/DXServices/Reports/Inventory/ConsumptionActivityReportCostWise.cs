...
{
    public partial class ConsumptionActivityReportCostWise
    {
        private int _tenantId;
        public string DecimalPoints = "";
        public ConsumptionActivityReportCostWise()
        {
            InitializeComponent();
        }
        ...
        private void AdjustmentReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.tableCell3.TextFormatString = "{0:N" + DecimalPoints + "}";
            this.tableCell2.TextFormatString = "{0:N" + DecimalPoints + "}";
