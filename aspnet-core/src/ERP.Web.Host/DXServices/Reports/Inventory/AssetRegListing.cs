...
{
    public partial class AssetRegListing
    {
        private int _tenantId;

        public AssetRegListing()
        {
            InitializeComponent();
        }
        private void AssetRegListing_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
