...
{
    public partial class AssetRegistraionReport
    {
        private int _tenantId;
        public AssetRegistraionReport()
        {
            InitializeComponent();
        }
        private void AssetRegistraionReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
