...
{
    public partial class ActualAndBudget
    {
        private int _tenantId;
        public string DecimalPoints = "";
        public ActualAndBudget()
        {
            InitializeComponent();
        }
        ...
        private void ActualAndBudget_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
