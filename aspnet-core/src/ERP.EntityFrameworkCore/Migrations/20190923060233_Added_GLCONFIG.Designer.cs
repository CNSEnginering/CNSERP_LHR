...
namespace ERP.Migrations
{
    ...
    [Migration("20190923060233_Added_GLCONFIG")]
    partial class Added_GLCONFIG
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.CommonServices.CompanyProfile", b =>
                {
                    ...
                    b.Property<DateTime?>("FiscalStartDate");
            ...
            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.ChartofControl", b =>
                {
                    ...
                    b.HasIndex("ControlDetailId");

                    b.HasIndex("Segmentlevel3Id");

                    b.HasIndex("SubControlDetailId");
            ...
            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.CompanySetup", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<bool>("ALLOWPOSTPREV");

                    b.Property<bool>("ALLOWPOSTPROV");
            ...
            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.GLCONFIG", b =>
                {
                    ...
                    b.Property<string>("ChartofControlId");

                    b.Property<int>("ConfigID");

                    b.Property<string>("GLBOOKSId");
                    ...
                    b.HasIndex("ChartofControlId");

                    b.HasIndex("GLBOOKSId");
            ...
            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.ChartofControl", b =>
                {
                    b.HasOne("ERP.GeneralLedger.SetupForms.ControlDetail", "ControlDetailFk")
                        .WithMany()
                        .HasForeignKey("ControlDetailId");

                    b.HasOne("ERP.GeneralLedger.SetupForms.Segmentlevel3", "Segmentlevel3Fk")
                        .WithMany()
                        .HasForeignKey("Segmentlevel3Id");

                    b.HasOne("ERP.GeneralLedger.SetupForms.SubControlDetail", "SubControlDetailFk")
                        .WithMany()
                        .HasForeignKey("SubControlDetailId");
                });

            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.ControlDetail", b =>
                {
                    b.HasOne("ERP.GeneralLedger.SetupForms.GroupCategory", "GroupCategoryFk")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.CurrencyRate", b =>
                {
                    b.HasOne("ERP.CommonServices.CompanyProfile", "CompanyProfileFk")
                        .WithMany()
                        .HasForeignKey("CMPID");
                });
            ...
            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.GLCONFIG", b =>
                {
                    b.HasOne("ERP.GeneralLedger.SetupForms.ChartofControl", "ChartofControlFk")
                        .WithMany()
                        .HasForeignKey("ChartofControlId");

                    b.HasOne("ERP.GeneralLedger.SetupForms.GLBOOKS", "GLBOOKSFk")
                        .WithMany()
                        .HasForeignKey("GLBOOKSId");
                });
            ...
            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.GroupCode", b =>
                {
                    b.HasOne("ERP.GeneralLedger.SetupForms.GroupCategory", "GroupCategoryFk")
                        .WithMany()
                        .HasForeignKey("GRPCTCODE")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("ERP.GeneralLedger.SetupForms.TaxAuthority", b =>
                {
                    b.HasOne("ERP.CommonServices.CompanyProfile", "CompanyFk")
                        .WithMany()
