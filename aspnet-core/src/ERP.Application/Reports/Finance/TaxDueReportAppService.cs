...
{
    public class TaxDueReportAppService : ERPReportAppServiceBase , ITaxDueReportAppService
    {
        ...
        public List<TaxDueReportDto> GetData(int? TenantId, string fromDate, string toDate, string fromAcc, string toAcc, string fromSubAcc, string toSubAcc, string taxAuth, string taxClass, string type)
        {
            if (TenantId == null)
            {
            ...
            && taxAuth == o.TaxAuth && taxClass == o.TaxClass.ToString() && o.TypeID==type && o.CprNo==null || o.CprNo=="");
            var directInvoiceD = _glinvDetailRepository.GetAll().Where(o => o.TenantId == TenantId && o.AccountID.CompareTo(fromAcc) >= 0 && o.AccountID.CompareTo(toAcc) <= 0 && o.SubAccID>0
            ...
            var data = from a in directInvoiceH
                       ...
                       select new TaxDueReportDto
                       {
                            ...
                            VendorRegNo = c.RegNo,
                            TaxAmount = b.Amount.ToString(),
                            TaxDeduct = a.TaxAmount.ToString(),
