...
namespace ERP.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ERPAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ERPDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(ERPConsts.ConnectionStringName).Value.ToString();
        }
