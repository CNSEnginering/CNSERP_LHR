...
namespace ERP.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ERPServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("ERP", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
