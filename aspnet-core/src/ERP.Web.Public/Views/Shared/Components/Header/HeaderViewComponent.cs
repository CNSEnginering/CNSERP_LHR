...
using ERP.Url;
using ERP.Web.Public.Startup;
using ERP.Web.Session;

namespace ERP.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ERPViewComponent
    {
