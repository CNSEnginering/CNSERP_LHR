...
{
    public interface IAssetlistingAppService: IApplicationService
    {
        List<Assetdetail> GetData(int tenantId, string fromLocId, string toLocId, string fromDate, string toDate);
    }
