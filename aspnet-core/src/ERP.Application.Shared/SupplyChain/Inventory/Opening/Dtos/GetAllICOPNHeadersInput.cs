...
{
    public class GetAllICOPNHeadersInput : PagedAndSortedResultRequestDto
    {
		...
		public decimal? MaxTotalItemsFilter { get; set; }
		public decimal? MinTotalItemsFilter { get; set; }
